# MYRED stress test — 2026-08-15 23:47:14
...
-- Platform (read from the kernel) ---------------------
  ...
  Governor:     n/a
  Load average: 0.68 0.30 0.22 1/375 57725
  somaxconn:    4096   nofile=10240   tcp_ulp=tls
  Build:        release  [build-rel/]
  Log:          docs/logs/WSL/full_tls.md

✓ Spawned the primary instance on 127.0.0.1:12591  (/tmp/myred-primary-uxk3_20j)
...
── BGSAVE (fork-based background save) ───────────────
  ...
  ℹ  bgsave returned in 1.9ms: 'Background saving started'
  ✓ server responsive during save
  ℹ  100 ops during save took 15.3ms
...
── Pub/Sub: fan-out under concurrent publishers ──────
  ...
  ✓ every subscriber received every message
    4 publishers × 250 msgs → 4 subscribers = 4000 deliveries in 0.78s (5,153 deliveries/s)

═══════════════════════════════════════════════════════
  Managed-instance phases
═══════════════════════════════════════════════════════
  Binary:   /home/kyled/projects/testfiles/build-rel/server
  Workdir:  /tmp/myred-suite-degoyj7o
  Ports:    from 12500
...
── Auth: async verify, pipelining, lockout, loop latency 
  ...
  info PING during an AUTH storm: p50=0.12ms p99=0.26ms
...
── TLS: handshake and live certificate rotation ──────
  ...
  info hot reload took 1.32ms (a restart costs tens of ms and drops every connection)
...
Runtime: 59.05s (17.3 assertions/sec)
All tests passed!
Slowest sections:
  7.96s  11/11  Pub/Sub: keyspace notifications (V8.3)
  7.00s  3/3  Replication: an idle link must survive
  5.33s  7/7  Security: protocol abuse (server must keep serving)
  5.28s  47/47  Replication: coordinated FAILOVER
  4.02s  9/9  Replication: REPLCONF ACK + WAIT
  3.61s  15/15  Replication: min-replicas-to-write durability floor
  3.21s  11/11  Replication: a wedged link (silent, not closed)
  3.15s  14/14  Persistence: BGREWRITEAOF (manual + auto-trigger)
═══════════════════════════════════════════════════════
...
── Stress Test ────────────────────────────────────────
  ...
  No errors!
  Operation mix:
    lpush                 124 ok     0 errors
    get                   123 ok     0 errors
    hset                  116 ok     0 errors
    lrange                116 ok     0 errors
    rpush                 115 ok     0 errors
    getdel                115 ok     0 errors
    setnx                 115 ok     0 errors
    srandmember           112 ok     0 errors
    smembers              111 ok     0 errors
    zscore                109 ok     0 errors
    ping                  108 ok     0 errors
    strlen                108 ok     0 errors
  Slowest operations by average latency:
    keyspace_scan          6.95ms avg over 100 ops
    ttl_triplet            4.52ms avg over 101 ops
    list_pop_trim          4.43ms avg over 92 ops
    getex_px               3.36ms avg over 100 ops
    object_encoding        2.97ms avg over 98 ops
    keys                   1.93ms avg over 99 ops
    info                   1.77ms avg over 92 ops
    config_get             1.68ms avg over 103 ops
    hgetall                1.64ms avg over 98 ops
    append                 1.62ms avg over 94 ops
    hscan                  1.60ms avg over 100 ops
    srandmember            1.57ms avg over 112 ops
...
═══════════════════════════════════════════════════════
  ...
  PING_INLINE: 561797.75 requests per second, p50=0.567 msec
  PING_MBULK: rps=197035.9 (overall: 466566.0) avg_msec=0.912 (overall: 0.912)
  PING_MBULK: 564971.75 requests per second, p50=0.575 msec
  SET: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  SET: 543478.25 requests per second, p50=0.711 msec
  GET: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  GET: 549450.56 requests per second, p50=0.663 msec
  INCR: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  INCR: 531914.94 requests per second, p50=0.815 msec
  LPUSH: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  LPUSH: 529100.56 requests per second, p50=0.879 msec
  RPUSH: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  RPUSH: 515463.91 requests per second, p50=0.783 msec
  LPOP: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  LPOP: 510204.09 requests per second, p50=0.735 msec
  RPOP: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  RPOP: 537634.38 requests per second, p50=0.775 msec
  SADD: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  SADD: 526315.81 requests per second, p50=0.847 msec
  HSET: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  HSET: 526315.81 requests per second, p50=0.983 msec
  SPOP: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  SPOP: 568181.81 requests per second, p50=0.591 msec
  ZADD: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  ZADD: 507614.22 requests per second, p50=0.967 msec
  ZPOPMIN: rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  ZPOPMIN: 568181.81 requests per second, p50=0.671 msec
  LPUSH (needed to benchmark LRANGE): rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  LPUSH (needed to benchmark LRANGE): 510204.09 requests per second, p50=0.943 msec
  LRANGE_100 (first 100 elements): rps=11456.0 (overall: 33694.1) avg_msec=14.892 (overall: 14.892)
  LRANGE_100 (first 100 elements): rps=85545.8 (overall: 72428.6) avg_msec=9.215 (overall: 9.883)
  LRANGE_100 (first 100 elements): rps=86016.0 (overall: 78225.2) avg_msec=9.221 (overall: 9.573)
  LRANGE_100 (first 100 elements): rps=89664.0 (overall: 81645.9) avg_msec=8.833 (overall: 9.330)
  LRANGE_100 (first 100 elements): rps=78916.3 (overall: 81015.6) avg_msec=10.014 (overall: 9.484)
  LRANGE_100 (first 100 elements): 82236.84 requests per second, p50=8.951 msec
  LRANGE_300 (first 300 elements): rps=5400.0 (overall: 12385.3) avg_msec=35.307 (overall: 35.307)
  LRANGE_300 (first 300 elements): rps=32860.6 (overall: 26661.1) avg_msec=8.704 (overall: 12.446)
  LRANGE_300 (first 300 elements): rps=30944.0 (overall: 28416.4) avg_msec=9.451 (overall: 11.109)
  LRANGE_300 (first 300 elements): rps=28278.9 (overall: 28376.3) avg_msec=9.848 (overall: 10.743)
  LRANGE_300 (first 300 elements): rps=26860.6 (overall: 28034.2) avg_msec=10.478 (overall: 10.686)
  LRANGE_300 (first 300 elements): rps=24256.0 (overall: 27340.7) avg_msec=12.352 (overall: 10.957)
  LRANGE_300 (first 300 elements): rps=28749.0 (overall: 27559.8) avg_msec=9.912 (overall: 10.787)
  LRANGE_300 (first 300 elements): rps=29190.5 (overall: 27780.2) avg_msec=10.275 (overall: 10.715)
  LRANGE_300 (first 300 elements): rps=30175.3 (overall: 28064.3) avg_msec=9.274 (overall: 10.531)
  LRANGE_300 (first 300 elements): rps=29496.0 (overall: 28215.6) avg_msec=9.680 (overall: 10.437)
  LRANGE_300 (first 300 elements): rps=29031.7 (overall: 28294.1) avg_msec=9.942 (overall: 10.388)
  LRANGE_300 (first 300 elements): rps=29416.0 (overall: 28391.9) avg_msec=10.018 (overall: 10.355)
  LRANGE_300 (first 300 elements): rps=30494.0 (overall: 28561.1) avg_msec=9.223 (overall: 10.257)
  LRANGE_300 (first 300 elements): rps=30812.8 (overall: 28728.8) avg_msec=9.841 (overall: 10.224)
  LRANGE_300 (first 300 elements): 28843.38 requests per second, p50=8.863 msec
  LRANGE_500 (first 500 elements): rps=5607.8 (overall: 9727.9) avg_msec=28.331 (overall: 28.331)
  LRANGE_500 (first 500 elements): rps=15708.7 (overall: 13516.2) avg_msec=16.009 (overall: 19.260)
  LRANGE_500 (first 500 elements): rps=14972.1 (overall: 14076.7) avg_msec=17.069 (overall: 18.363)
  LRANGE_500 (first 500 elements): rps=15996.0 (overall: 14608.6) avg_msec=16.197 (overall: 17.706)
  LRANGE_500 (first 500 elements): rps=16180.0 (overall: 14949.7) avg_msec=16.109 (overall: 17.331)
  LRANGE_500 (first 500 elements): rps=15099.6 (overall: 14976.5) avg_msec=16.827 (overall: 17.240)
  LRANGE_500 (first 500 elements): rps=15242.2 (overall: 15017.5) avg_msec=16.326 (overall: 17.097)
  LRANGE_500 (first 500 elements): rps=15232.0 (overall: 15045.6) avg_msec=16.345 (overall: 16.997)
  LRANGE_500 (first 500 elements): rps=15976.1 (overall: 15153.7) avg_msec=15.541 (overall: 16.819)
  LRANGE_500 (first 500 elements): rps=16103.6 (overall: 15252.6) avg_msec=15.625 (overall: 16.687)
  LRANGE_500 (first 500 elements): rps=16240.0 (overall: 15345.4) avg_msec=16.164 (overall: 16.635)
  LRANGE_500 (first 500 elements): rps=16243.0 (overall: 15422.7) avg_msec=16.306 (overall: 16.606)
  LRANGE_500 (first 500 elements): rps=15916.3 (overall: 15461.9) avg_msec=16.549 (overall: 16.601)
  LRANGE_500 (first 500 elements): rps=15729.1 (overall: 15481.5) avg_msec=15.974 (overall: 16.554)
  LRANGE_500 (first 500 elements): rps=15270.9 (overall: 15467.1) avg_msec=15.723 (overall: 16.498)
  LRANGE_500 (first 500 elements): rps=15600.0 (overall: 15475.6) avg_msec=16.247 (overall: 16.482)
  LRANGE_500 (first 500 elements): rps=16195.2 (overall: 15519.0) avg_msec=16.310 (overall: 16.471)
  LRANGE_500 (first 500 elements): rps=15884.5 (overall: 15539.7) avg_msec=16.221 (overall: 16.456)
  LRANGE_500 (first 500 elements): rps=16259.0 (overall: 15578.4) avg_msec=16.534 (overall: 16.461)
  LRANGE_500 (first 500 elements): rps=16036.0 (overall: 15601.7) avg_msec=16.050 (overall: 16.439)
  LRANGE_500 (first 500 elements): rps=15287.4 (overall: 15586.2) avg_msec=16.543 (overall: 16.444)
  LRANGE_500 (first 500 elements): rps=15347.7 (overall: 15575.0) avg_msec=16.720 (overall: 16.457)
  LRANGE_500 (first 500 elements): rps=15972.4 (overall: 15592.7) avg_msec=16.932 (overall: 16.479)
  LRANGE_500 (first 500 elements): rps=14980.1 (overall: 15566.8) avg_msec=16.394 (overall: 16.475)
  LRANGE_500 (first 500 elements): rps=-2246.2 (overall: 23599.9) avg_msec=15.936 (overall: 16.454)
  LRANGE_500 (first 500 elements): 23277.47 requests per second, p50=16.135 msec
  LRANGE_600 (first 600 elements): rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  LRANGE_600 (first 600 elements): rps=12496.0 (overall: 10710.9) avg_msec=22.989 (overall: 22.989)
  LRANGE_600 (first 600 elements): rps=12545.1 (overall: 11562.8) avg_msec=19.416 (overall: 21.189)
  LRANGE_600 (first 600 elements): rps=13067.2 (overall: 12037.4) avg_msec=19.732 (overall: 20.690)
  LRANGE_600 (first 600 elements): rps=13196.0 (overall: 12312.7) avg_msec=19.397 (overall: 20.361)
  LRANGE_600 (first 600 elements): rps=13091.6 (overall: 12462.8) avg_msec=18.880 (overall: 20.061)
  LRANGE_600 (first 600 elements): rps=13080.0 (overall: 12562.1) avg_msec=18.893 (overall: 19.865)
  LRANGE_600 (first 600 elements): rps=13063.7 (overall: 12631.9) avg_msec=18.908 (overall: 19.727)
  LRANGE_600 (first 600 elements): rps=13159.4 (overall: 12696.3) avg_msec=19.462 (overall: 19.694)
  LRANGE_600 (first 600 elements): rps=12944.0 (overall: 12723.2) avg_msec=19.981 (overall: 19.725)
  LRANGE_600 (first 600 elements): rps=12976.1 (overall: 12748.0) avg_msec=19.095 (overall: 19.662)
  LRANGE_600 (first 600 elements): rps=13027.9 (overall: 12773.1) avg_msec=19.600 (overall: 19.657)
  LRANGE_600 (first 600 elements): rps=13394.4 (overall: 12824.1) avg_msec=19.213 (overall: 19.619)
  LRANGE_600 (first 600 elements): rps=12764.9 (overall: 12819.6) avg_msec=19.629 (overall: 19.620)
  LRANGE_600 (first 600 elements): rps=13360.0 (overall: 12857.5) avg_msec=18.742 (overall: 19.556)
  LRANGE_600 (first 600 elements): rps=13063.7 (overall: 12871.1) avg_msec=19.525 (overall: 19.554)
  LRANGE_600 (first 600 elements): rps=13543.3 (overall: 12913.1) avg_msec=19.660 (overall: 19.560)
  LRANGE_600 (first 600 elements): rps=13213.4 (overall: 12930.7) avg_msec=19.241 (overall: 19.541)
  LRANGE_600 (first 600 elements): rps=13468.3 (overall: 12960.4) avg_msec=19.247 (overall: 19.524)
  LRANGE_600 (first 600 elements): rps=13677.3 (overall: 12997.7) avg_msec=19.979 (overall: 19.549)
  LRANGE_600 (first 600 elements): rps=13152.0 (overall: 13005.3) avg_msec=19.609 (overall: 19.552)
  LRANGE_600 (first 600 elements): rps=13095.6 (overall: 13009.6) avg_msec=19.288 (overall: 19.540)
  LRANGE_600 (first 600 elements): rps=13188.0 (overall: 13017.6) avg_msec=19.526 (overall: 19.539)
  LRANGE_600 (first 600 elements): rps=13176.0 (overall: 13024.4) avg_msec=19.599 (overall: 19.542)
  LRANGE_600 (first 600 elements): rps=12920.3 (overall: 13020.1) avg_msec=19.771 (overall: 19.551)
  LRANGE_600 (first 600 elements): rps=13404.0 (overall: 13035.3) avg_msec=19.431 (overall: 19.546)
  LRANGE_600 (first 600 elements): rps=12486.1 (overall: 13014.3) avg_msec=20.390 (overall: 19.577)
  LRANGE_600 (first 600 elements): rps=12876.0 (overall: 13009.2) avg_msec=20.015 (overall: 19.593)
  LRANGE_600 (first 600 elements): rps=13119.5 (overall: 13013.1) avg_msec=19.524 (overall: 19.591)
  LRANGE_600 (first 600 elements): rps=13162.7 (overall: 13018.3) avg_msec=19.333 (overall: 19.582)
  LRANGE_600 (first 600 elements): rps=13520.0 (overall: 13034.8) avg_msec=19.617 (overall: 19.583)
  LRANGE_600 (first 600 elements): 13068.48 requests per second, p50=19.455 msec
  MSET (10 keys): rps=0.0 (overall: 0.0) avg_msec=-nan (overall: -nan)
  MSET (10 keys): rps=214656.0 (overall: 186333.3) avg_msec=3.966 (overall: 3.966)
  MSET (10 keys): 198807.16 requests per second, p50=3.663 msec

-- Throughput summary ----------------------------------
  test                    ops/sec    p50 ms
  spop                    568,182     0.591
  zpopmin                 568,182     0.671
  ping_mbulk              564,972     0.575
  ping_inline             561,798     0.567
  get                     549,451     0.663
  set                     543,478     0.711
  rpop                    537,634     0.775
  incr                    531,915     0.815
  ...
  zadd                    507,614     0.967
  mset                    198,807     3.663
  lrange_100               82,237     8.951
  lrange_300               28,843     8.863
  lrange_500               23,277    16.135
  lrange_600               13,068    19.455

-- Command Metrics -------------------------------------
  Commands observed: 40078
  RESP errors:       214 (expected negative tests included)
  Transport errors:  0
  Latency avg:       0.52ms
  Latency p50/p95/p99: 0.14/1.92/3.07ms
  Latency max:       1013.75ms
  Most used commands:
    set             26213 calls
    zadd             2022 calls
    rpush            1433 calls
    ...
    hset              437 calls
    srem              400 calls
    srandmember       368 calls
    type              361 calls
  Slowest commands by average latency:
    wait             628.83ms avg over 4 calls
    auth              39.79ms avg over 2 calls
    save               5.27ms avg over 3 calls
    acl                4.92ms avg over 36 calls
    scan               2.04ms avg over 103 calls
    bgsave             1.87ms avg over 2 calls
    keys               1.82ms avg over 106 calls
    getex              1.63ms avg over 109 calls
    rpop               1.56ms avg over 93 calls
    hgetall            1.55ms avg over 104 calls
    bgrewriteaof       1.54ms avg over 4 calls
    hscan              1.54ms avg over 104 calls
...
═══════════════════════════════════════════════════════
  ...
  Log:     docs/logs/WSL/full_tls.md
  Summary: docs/logs/WSL/full_tls.json
